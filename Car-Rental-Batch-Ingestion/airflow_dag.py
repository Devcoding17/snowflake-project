...
merge_customer_dim = SnowflakeOperator(
    ...
    snowflake_conn_id='snowflake-conn-v2',
    sql="""
...
CLUSTER_NAME = 'cluster-8945'
PROJECT_ID = 'eminent-clover-428817-h5'
REGION = 'us-central1'

pyspark_job_file_path = 'gs://snowflake-project/spark_job/spark_job.py'
...
submit_pyspark_job = DataprocSubmitPySparkJobOperator(
    ...
    dag=dag,
    dataproc_jars=['gs://snowflake-project/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.2.jar', 'gs://snowflake-project/snowflake_jars/snowflake-jdbc-3.16.0.jar']
)                      
