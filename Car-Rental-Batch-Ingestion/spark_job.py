...
def process_car_rental_data(data_date):
    ...
    spark = SparkSession.builder \
        ...
        .config("spark.jars", "gs://snowflake-project/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.2.jar,gs://snowflake-project/snowflake_jars/snowflake-jdbc-3.16.0.jar") \
        .getOrCreate()

    # Define GCS file path based on the date argument
    gcs_file_path = f"gs://snowflake-project/car_rental_data/car_rental_daily_data/car_rental_{data_date}.json"
    ...
    snowflake_options = {
        "sfURL": "https://tfmwkde-nh67906.snowflakecomputing.com",
        "sfAccount": "tfmwkde-nh67906",
        "sfUser": "Devparmar",
        "sfPassword": "Devparmar17",
